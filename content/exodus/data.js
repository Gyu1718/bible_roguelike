window.EXODUS_DATA = {
  ...
  scenes: [
    ...
    { id: "scene_02_overseer_whip", title: "채찍 소리", art: "감독관과 채찍", artLabel: "채찍 아래의 노동장", artSrc: "./assets/scenes/exodus/scene_01_brickyard.svg", text: "감독관이 노인을 끌어낸다. 그는 오늘 몫을 채우지 못했다. 사람들은 고개를 숙이고, 채찍은 이미 올라가 있다.", choices: [
    ...
    { id: "scene_08_blood_door", title: "문설주의 피", art: "피가 발린 문설주", artLabel: "유월절의 문", artSrc: "./assets/scenes/exodus/scene_01_brickyard.svg", text: "그 밤, 말씀은 구체적이었다. 어린 양, 피, 문설주, 허리에 띤 띠, 발의 신, 손의 지팡이.", choices: [
    ...
    { id: "scene_10_chariots_dust", title: "뒤에서 들리는 병거", art: "광야의 먼지와 병거 소리", artLabel: "뒤쫓는 병거", artSrc: "./assets/scenes/exodus/scene_11_red_sea_waiting.svg", text: "광야의 먼지 사이로 낮은 진동이 들린다. 병거다. 애굽이 따라오고 있다.", choices: [
    ...
    { id: "scene_12_red_sea_crossing", title: "벽돌 굽던 발이 바다 사이를 걷다", art: "물벽 사이의 길", artLabel: "홍해 도하", artSrc: "./assets/scenes/exodus/scene_12_red_sea_crossing.svg", text: "모세가 지팡이를 든다. 밤새 바람이 분다. 바다가 물러난다. 당신은 진흙과 벽돌만 알던 발로, 물벽 사이의 마른 길을 밟는다.", final: true }
  ]
};
